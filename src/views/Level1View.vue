  ...
  <div style="display: flex;">
    ...
    <div class="grid">
      <div v-for="(row, rowIndex) in grid" :key="rowIndex" class="row">
        ...
        >
          <div class="drop-zone">
            <div class="letter" :style="{ backgroundColor: cell.color }" v-if="cell.isPlaced == 1">{{ cell.letter }}</div>
...
.cell {
  width: 100px; /* Adjust the cell width as needed */
  height: 100px; /* Adjust the cell height as needed */
